...
func (uc *VehicleRunUseCase) GetVehicleRunByFiltersPaged(ctx context.Context, filters *models.VehicleRunModelFilters, limit int64, offset int64) ([]models.VehicleRunModel, error) {
